...
3. **التأمين والصلاحيات:** حماية الدخول بنظام الصلاحيات الذكي برمز PIN الخاص بك:
   * **`1975`** ➔ مدير النظام الماستر (كامل الصلاحيات والتعديل وإدارة كلمات السر).
   * **`2026`** ➔ إداري ومُدخل بيانات (إضافة، تعديل، موقف، إجازات، إضافي).
   * **`1234`** ➔ مستعرض فقط (عرض وقراءة الملاك والطباعة).
